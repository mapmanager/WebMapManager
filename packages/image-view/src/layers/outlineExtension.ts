...
// This shader extension adds the ability to draw an outline around paths.
...
export class OutlinePathExtension
  extends LayerExtension<OutlinePathExtensionOptions> {
